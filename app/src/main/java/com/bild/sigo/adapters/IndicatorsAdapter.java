...
public class IndicatorsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public IndicatorsAdapter(BaseActivity activity, List<String> listApps, OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new IndicatorsAdapter.ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_application, viewGroup, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final IndicatorsAdapter.ViewHolder mHolderSeccion = (IndicatorsAdapter.ViewHolder) holder;
